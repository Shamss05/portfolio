...
const projects = [
  { id: 1, title: 'ForCoaching intro', description: 'Portfolio video project', technologies: ['Video'], video: 'ForCoaching intro.mp4', liveLink: '/portfolio/public/Videos/ForCoaching intro.mp4', group: 'youtube' },
  { id: 2, title: 'Ghalia & 7.7', description: 'Portfolio video project', technologies: ['Reel'], video: 'Ghalia & 7.7.mp4', liveLink: '/portfolio/public/Videos/Ghalia & 7.7.mp4', group: 'reel' },
  { id: 3, title: 'Red Sharm promo', description: 'Portfolio video project', technologies: ['Promo'], video: 'Red Sharm promo.mp4', liveLink: '/portfolio/public/Videos/Red Sharm promo.mp4', group: 'promo' },
  { id: 4, title: 'Reel sample', description: 'Portfolio video project', technologies: ['Reel'], video: 'Reel sample.mp4', liveLink: '/portfolio/public/Videos/Reel sample.mp4', group: 'reel' },
  { id: 5, title: 'TUTHUB VID', description: 'Portfolio video project', technologies: ['Reel'], video: 'TUTHUB VID.mp4', liveLink: '/portfolio/public/Videos/TUTHUB VID.mp4', group: 'reel' },
  // Removed YouTube Sample.mp4 due to file size exceeding GitHub's 100MB limit
];
